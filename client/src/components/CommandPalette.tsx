...
const buildCommands = (): CommandItem[] => [
  ...
  // Projects — each dispatches a custom event to open the specific card
  { id: "proj-analytics", icon: "🧠", label: "Analytics Agent Recipes", sublabel: "AI · 10× faster insights", category: "PROJECT", color: "#A78BFA", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "ai", projectId: "analytics-agent" } })) },
  { id: "proj-metamate", icon: "⚡", label: "Metamate Automation", sublabel: "AI · 60% cycle reduction", category: "PROJECT", color: "#C084FC", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "ai", projectId: "metamate" } })) },
  { id: "proj-manus", icon: "🧩", label: "Manus Framework", sublabel: "AI · Agentic orchestration", category: "PROJECT", color: "#818CF8", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "ai", projectId: "manus-framework" } })) },
  { id: "proj-genai", icon: "🎬", label: "GenAI Video Generation", sublabel: "AI · $M+ revenue impact", category: "PROJECT", color: "#F472B6", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "ai", projectId: "genai-video" } })) },
  { id: "proj-pltv", icon: "📈", label: "pLTV Model", sublabel: "Revenue · +28% ROAS", category: "PROJECT", color: "#C8A96E", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "revenue", projectId: "pltv" } })) },
  { id: "proj-value-opt", icon: "💰", label: "Value Optimization", sublabel: "Revenue · +22% conversion value", category: "PROJECT", color: "#C8A96E", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "revenue", projectId: "value-optimization" } })) },
  { id: "proj-passback", icon: "🔗", label: "Custom Passback Attribution", sublabel: "Revenue · 3× accuracy", category: "PROJECT", color: "#F59E0B", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "revenue", projectId: "custom-passback" } })) },
  { id: "proj-hec", icon: "🏛️", label: "HEC Compliance", sublabel: "Legal · Housing/Employment/Credit", category: "PROJECT", color: "#60A5FA", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "legal", projectId: "hec" } })) },
  { id: "proj-ccpa", icon: "🔒", label: "CCPA Compliance", sublabel: "Legal · Zero violations", category: "PROJECT", color: "#34D399", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "legal", projectId: "ccpa" } })) },
  { id: "proj-gdpr", icon: "🇪🇺", label: "GDPR Compliance", sublabel: "Legal · €0 fines", category: "PROJECT", color: "#60A5FA", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "legal", projectId: "gdpr" } })) },
  { id: "proj-long-consideration", icon: "🏠", label: "Long Consideration Optimization", sublabel: "Product · +41% lead quality", category: "PROJECT", color: "#34D399", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "product", projectId: "long-consideration" } })) },
  { id: "proj-instore", icon: "🏪", label: "In-Store Offer Ads", sublabel: "Product · O2O attribution", category: "PROJECT", color: "#4ADE80", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "product", projectId: "instore-offer" } })) },
  { id: "proj-fbwifi", icon: "📶", label: "FBWifi", sublabel: "Product · 10M+ connections", category: "PROJECT", color: "#22D3EE", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "product", projectId: "fbwifi" } })) },
  { id: "proj-nft", icon: "🎨", label: "NFT Airdrop", sublabel: "Product · 500K+ NFTs", category: "PROJECT", color: "#F472B6", action: () => window.dispatchEvent(new CustomEvent("select-meta-project", { detail: { categoryId: "product", projectId: "nft-airdrop" } })) },
  // Contact
